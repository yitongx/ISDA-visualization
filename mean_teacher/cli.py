...
def create_parser():
    ...
    parser.add_argument('--eval_subdir', type=str, default='val',
    ...
    parser.add_argument('--consistency_rampup', default=30, type=int, metavar='EPOCHS',
                        help='length of the consistency loss ramp-up')
    parser.add_argument('--logit_distance_cost', default=-1, type=float, metavar='WEIGHT',
